//
//  UIColor+WoWClassColor.swift
//  WoW-Realm-Status
//
//  Created by Keli'i Martin on 3/31/16.
...
extension UIColor
{
    @nonobjc class var deathKnightColor: UIColor
    {
    ...
    @nonobjc class var demonHunterColor: UIColor
    {
    ...
    @nonobjc class var druidColor: UIColor
    {
    ...
    @nonobjc class var hunterColor: UIColor
    {
    ...
    @nonobjc class var mageColor: UIColor
    {
    ...
    @nonobjc class var monkColor: UIColor
    {
    ...
    @nonobjc class var paladinColor: UIColor
    {
    ...
    @nonobjc class var priestColor: UIColor
    {
    ...
    @nonobjc class var rogueColor: UIColor
    {
    ...
    @nonobjc class var shamanColor: UIColor
    {
    ...
    @nonobjc class var warlockColor: UIColor
    {
    ...
    @nonobjc class var warriorColor: UIColor
    {
